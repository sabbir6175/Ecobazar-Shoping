...
const ShoppingCart = () => {
  return (
    <>
      <Helmet>
        <title>EcoBazar Shopping | ShoppingCart </title>
      </Helmet>
                ...
                <tr className="border-b">
                  <td className="px-4 py-4 flex items-center space-x-4">
                    <img
                      ...
                      alt="Green Capsicum"
                      className="w-6 md:w-8 h-6 md:h-8  object-cover rounded-md"
                    />
                    <h2 className="font-medium text-xs md:text-sm">
                      Green Capsicum
                    </h2>
                  </td>
                  <td className="px-4 py-4  text-xs md:text-sm font-semibold">
                    $14.00
                  </td>
                  <td className="px-4 py-4">
                    <div className="flex items-center bg-white border border-gray-300 rounded-full px-2 py-1 w-fit space-x-4">
                      <div className="w-6 md:w-8 h-6 md:h-8  flex items-center justify-center bg-gray-100 rounded-full text-gray-700 text-xl cursor-default">
                        -
                      </div>
