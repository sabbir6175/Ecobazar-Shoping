    ...
    <>
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6 space-y-6 lg:space-y-0 mb-6">
          ...
          <div className="flex-1 bg-white shadow-md rounded-lg p-4 sm:p-6 overflow-x-auto">
            <table className="min-w-full table-auto">
              <thead className="bg-gray-100">
                <tr>
                  <th className="px-4 sm:px-6 py-3 text-sm font-medium text-gray-500 text-left">
                    Product
                  </th>
                  <th className="px-4 sm:px-6 py-3 text-sm font-medium text-gray-500 text-left">
                    Price
              ...
              <tbody>
                ...
                <tr className="border-b">
                  <td className="px-2 sm:px-6 py-4 flex items-center space-x-4">
                    <img
                      src="https://t4.ftcdn.net/jpg/05/37/04/61/360_F_537046123_s8JVn2NrClPQDOryhSm8jonYZPfIzPRX.jpg"
                      alt="Green Capsicum"
                      className="w-8 h-8 object-cover rounded-md"
                    />
                    <h2 className="font-medium text-xm sm:text-lg">
                      Green Capsicum
                    </h2>
                  </td>
                  <td className="px-4 sm:px-6 py-4 md:text-lg font-semibold">
                    $14.00
                  </td>
                  ...
                  <td className="px-4 sm:px-6 py-4 text-lg font-semibold">
                    $70.00
                  </td>
                  <td className="px-4 sm:px-6 py-4">
          ...
          <div className="w-full lg:w-80 bg-white shadow-md rounded-lg p-4 sm:p-6">
