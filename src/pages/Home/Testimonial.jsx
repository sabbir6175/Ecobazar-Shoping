...
const Testimonial = () => {
  return (
    <section className=" px-4 lg:px-0 py-12 bg-gradient-to-b from-white to-gray-50 relative">
      {/* Title */}
      <div className="flex items-center justify-between">
        <div className="text-left mb-10">
          <p className="text-green-500 text-xs uppercase italic tracking-widest mb-1">
            Testimonial
          </p>
