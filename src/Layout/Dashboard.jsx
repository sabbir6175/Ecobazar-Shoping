...
import { AiOutlineDashboard, AiOutlineShoppingCart, AiOutlineSetting, AiOutlineHeart, AiOutlineLogout } from 'react-icons/ai';

const Dashboard = () => {
  return (
    <div className="flex flex-col lg:flex-row bg-[#F7F8F9] min-h-screen p-4 lg:p-8">
        ...
        <ul className="menu   menu-horizontal lg:menu-vertical rounded-box gap-1 lg:gap-3 justify-around">
          <li>
            <NavLink
              ...
              className={({ isActive }) => 
                `flex flex-col md:flex-row lg:gap-3 items-center p-2 rounded-box ${isActive ? 'bg-[#E5F5E5] text-[#48BB78] font-semibold' : ''}`
              }
            >
          ...
          <li className="mt-8 hidden lg:block">
            <a href="#" className="flex flex-col md:flex-row lg:gap-3 items-center p-2 rounded-box text-gray-500 hover:text-gray-700">
